/**
    ...
    function howManyGifts(maxBudget, gifts)
        ...
        Function ini harus mengembalikan nilai yang meunction howManyGifts(maxBudget, gifts) {
        wakili jumlah maksimum oleh-oleh yang Sergei dapat beli.
...
function howManyGifts(maxBudget, gifts) {
    let price = 0;
    let totalGifts = gifts.sort((a, b) => a - b)
    let temp = 0;
